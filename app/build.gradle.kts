    ...
    buildTypes {
        ...
        release {
            ...
            firebaseAppDistribution {
                ...
                groups = "zivaa-beta"
                releaseNotes = "Zivaa v1.0.51 - Rest Score v2 with WASO & HRV biometric metrics, decoupled asynchronous vitals rollup trigger, and personalized sleep analytics"
            }
            proguardFiles(
